...
# =============== USER CONFIGURATION ===============
corpus_name = "raleigh"
corpus_dir = "/mnt/e/temp/raleigh/small_raleigh"
textgrid_format = "MFA"
...
csv_path = os.path.join(base_dir, corpus_name + "_formants.csv")
...
if __name__ == '__main__':
    ...
    with ensure_local_database_running(corpus_name) as params:
        ...
        common.formant_acoustic_analysis(config, stressed_vowels)
        common.formant_export(config, stressed_vowels, csv_path, dialect_code)
        print('Finishing up!')
